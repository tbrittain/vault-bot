...
reactable(
  ...
  columns = list(
    User = colDef(align = "left",
                  style = list(fontFamily = "Roboto Mono, monospace", whiteSpace = "pre"),
                  footer = "Average"),
    Artist = colDef(align = "left",
                    style = list(fontFamily = "Rubik, Arial, Helvetica, sans-serif", whiteSpace = "pre")),
  ...
  style = list(fontFamily = "Roboto Mono, monospace", whiteSpace = "pre", fontSize = "14px"),
